...
[데모 사이트](https://dayongkr.github.io/skkuding-fe-study/3w/) 매주 이와 같은 데모 사이트를 제공할 거예요. 데모 사이트를 분석해서 어떻게 만들어야 할지 참고해 보세요!

![데모 사이트 분석](../images/fe-3weak-3.png)

처음에는 그냥 외관만 보고 따라 만들다가 막히는 경우 개발자 도구를 통해 분석하면서 만들어 보세요!
