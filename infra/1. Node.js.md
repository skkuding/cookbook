...
![실습 결과](../images/infra_week1_lab.png)
<img src="../images/infra_week1_lab.png" width="480" align="center">
...
- HTML 파일은 `assets` 폴더에 있는 `week1.html`을 사용해주세요. HTML 파일을 직접 수정할 필요는 없어요.
