...
{{< alert context="info" text="Git이 아직 익숙하지 않다면 GitHub Actions를 시작하기 전에 [Pro Git 한국어판](https://git-scm.com/book/ko/v2)을 먼저 훑어보세요. 시간이 많지 않다면 2장과 3장만 읽어도 충분하고, 조금 더 여유가 있다면 1장까지 함께 읽어보면 좋아요." />}}
